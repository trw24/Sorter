...
enyo.path.addPaths({layout: "/Users/troy/Documents/troywork/Edutraining/enyoAndCordova/Sorter/web_src/enyo/../lib/layout/", onyx: "/Users/troy/Documents/troywork/Edutraining/enyoAndCordova/Sorter/web_src/enyo/../lib/onyx/", onyx: "/Users/troy/Documents/troywork/Edutraining/enyoAndCordova/Sorter/web_src/enyo/../lib/onyx/source/"});
...
var n = t.charAt(t.length - 1) + e(t.substr(0, t.length - 1));
return n;
}, t = function(e) {
var t, r = e;
do {
swapped = !1;
for (var i = 0; i < r.length - 1; i++) r[i] > r[i + 1] && (r = n(r, i), swapped = !0);
} while (swapped == 1);
return r;
}, n = function(e, t) {
var n = e.substr(0, t) + e[t + 1] + e[t] + e.substr(t + 2);
return n;
}, r, i = function(e) {
r = e.split("");
}, s = function() {
...
var n = t - e + 1;
if (n <= 1) return;
var i = Math.floor((e + t) / 2);
u(e, i), u(i + 1, t);
var s = new Array(n), o = e, a = i + 1, f = 0;
while (o <= i && a <= t) r[o] < r[a] ? s[f++] = r[o++] : s[f++] = r[a++];
if (o > i) while (a <= t) s[f++] = r[a++]; else while (o <= i) s[f++] = r[o++];
for (o = e; o <= t; o++) r[o] = s[o - e];
return;
};
mySortMachine.reverseString = e, mySortMachine.bubbleSort = t, mySortMachine.setPrivateArray = i, mySortMachine.getPrivateArray = s, mySortMachine.mergeSort = o;
})();
...
clearTapped: function(e, t) {
this.$.aboutPopup.hide(), this.$.inputString.setValue(""), this.$.displayReverseString.setContent("-"), this.$.displayBubbleSort.setContent("-"), this.$.displayMergeSort.setContent("-"), this.$.inputString.addRemoveClass("column-right", !0), this.$.displayReverseString.addRemoveClass("column-right", !0), this.$.displayBubbleSort.addRemoveClass("column-right", !0), this.$.displayMergeSort.addRemoveClass("column-right", !0);
},
